...
export default function ThankYouReferral() {
  return (
    <div className='min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-teal/5 via-white to-brand-blue/5 px-4 py-20'>
      <div className='text-center max-w-lg'>
        ...
        <p className='text-base text-text-mid leading-relaxed mb-4'>
          Thank you for referring a patient to Capricorn Group Care. Our RN team
          will review the referral and respond within one business day to
        ...
        <ul className='text-sm text-text-mid mb-8 space-y-1'>
          <li>✓ Our clinical team will review the patient&apos;s care needs</li>
          <li>✓ We will contact you to confirm placement fit</li>
          <li>✓ Transition planning will begin promptly</li>
        </ul>
